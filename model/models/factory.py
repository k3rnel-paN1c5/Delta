...
class ModelFactory:
    ...
    @staticmethod
    def create_student_model(config: ModuleType) -> nn.Module:
        ...
        """
        model_name: str = getattr(config, "STUDENT_MODEL_NAME", "StudentDepthModel")
    ...
    @staticmethod
    def create_teacher_model(config: ModuleType) -> nn.Module:
        ...
        """
        model_name: str = getattr(config, "TEACHER_MODEL_NAME", "DepthAnythingV2")
